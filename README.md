...
Eine Arduino Bibliothek, um Selectrix Gleissignale zu dekodieren / BETA Version

Diese verwendet zB der "Arduino Lok-Decoder" (mit ATmega328), siehe
examples/Lokdec328Simple

Lesen Sie mehr (auch über die benötigte Add-On HW für den Arduino), unter:
<a href="http://opensx.net">opensx.net</a>

usage: 
- PX-master.zip herunterladen 
